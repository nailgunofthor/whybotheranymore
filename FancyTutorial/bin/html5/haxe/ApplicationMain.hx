...
class ApplicationMain {
	...
	public static function main() {
		...
		//flash.Lib.setPackage("Tara Moses", "FancyTutorial", "FancyTutorial", "1.0.0");
		...
		loaders.set("img/hungryTaraIcon.png", loader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("img/pizzaIcon.png", loader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("img/shipIcon.png", loader);
		total ++;
		...
		var loader:Loader = new Loader();
		loaders.set("img/tinymap.png", loader);
		total ++;
